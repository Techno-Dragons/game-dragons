...
////    }
//
//    public GlobalResponse<Page<ArticleResponseDto>> getArticles(int page) {
...
//
//        return GlobalResponse.of("200", "success", articles.map(this::getArticleResponse));
//    }
//
//    /**
//     * 게시글 단일조회
...
//     */
//    public GlobalResponse<ArticleResponseDto> getArticleResponseById(Long id) {
//        Optional<Article> article = articleRepository.findById(id);
//        if (article.isEmpty()) {
//            throw new EntityNotFoundException(ENTITY_NOT_FOUND + id);
//        }
//
//        return GlobalResponse.of("200", "success", getArticleResponse(article.get())) ;
//    }
//    @Override
//    public GlobalResponse<ArticleResponseDto> getArticleById(Long id) {
//        Optional<Article> article = articleRepository.findById(id);
//        if (article.isEmpty()) {
//            throw new EntityNotFoundException(ENTITY_NOT_FOUND + id);
//        }
