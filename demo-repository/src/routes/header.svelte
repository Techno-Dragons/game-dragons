    ...
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                ...
                {#if $isLogin}
                    <li><a class="nav-link" href="/member/mypage"> <i class="fa-solid fa-address-card"></i> 마이페이지</a>
                    </li>
                    <li><a class="nav-link" on:click={logoutProcess}> <i class="fa-solid fa-door-closed"></i>로그아웃</a>
                    </li>
                {:else}
