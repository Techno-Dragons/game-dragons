...
{#if isModify}
	...
	<div class="width-45 mr-auto ml-auto">
		<textarea class="textarea textarea-ghost text-4xl w-full" placeholder="제목을 입력해주세요." bind:value={modifyForm.title} />
		<div class="flex items-center space-x-2 mt-6" />
		<div class="divider divider-Neutral mb-1" />

		<div class="mt-8">
			<textarea class="textarea textarea-ghost mt-1 w-full h-screen" placeholder="내용을 입력해주세요." bind:value={modifyForm.content} />
		</div>
...
{:else}
	...
	{:then ard}
				...
				<div class="flex items-center space-x-2 mt-6">
				  <div class="flex-container">
					...
					<div class="flex space-x-4 mb-6 container flex-wrap flex-row-reverse">
						...
						<button class="btn border-gray-600 btn-ghost"
						on:click={() => {
						...
						<div class="width-45">
							...
							<div class="chat chat-end">
								...
								{#if isCommentModify[comment.id]}
									<textarea class="textarea textarea-primary" placeholder="댓글을 입력해주세요." bind:value={modifyCommentContent}></textarea>
									<button
										on:click={() => {
			...
			<div class="flex-container">
				<textarea class="textarea textarea-primary row-span-auto" placeholder="댓글을 입력해주세요."
			...
			<input type="button" class="btn border-gray-600 btn-ghost ml-1 mt-10" value="뒤로가기" on:click={() => history.back()} />
			</div>
