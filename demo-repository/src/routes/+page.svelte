                ...
                <div class="card-body flex flex-col">
                    {#if $isLogin}
                        ...
                        <div class="items-end text-end">
                            <a class="btn border-gray-600 btn-ghost" on:click={logoutProcess}> <i
                                    class="fa-solid fa-door-closed"></i>로그아웃</a>
                        </div>
                    {:else}
                        <div class="items-start">
                            <p>로그인 후 이용해보세요!</p>
                        ...
                        <div class="items-center">
                            <div class="card-actions justify-center">
                                <a class="btn border-gray-600 btn-ghost w-full" href="/member/login">Game Dragons
                                    로그인</a>
                            </div>
                        </div>
                        <div class="items-end text-end">
                            <a class="btn border-gray-600 btn-ghost" href="/member/signup"> <i
